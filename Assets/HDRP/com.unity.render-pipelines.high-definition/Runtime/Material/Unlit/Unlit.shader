Shader "HDRP/Unlit"
{
    ...
    #include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Material/Unlit/UnlitProperties.hlsl"
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Material/Unlit/Unlit.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Material/Unlit/ShaderPass/UnlitDepthPass.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Material/Unlit/UnlitData.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Material/Material.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Material/Unlit/Unlit.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Material/Unlit/ShaderPass/UnlitSharePass.hlsl"
			#include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Material/Unlit/UnlitData.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Material/Unlit/ShaderPass/UnlitSharePass.hlsl"
			#include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Material/Unlit/UnlitData.hlsl"
			#include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/RenderPipeline/ShaderPass/ShaderPassForwardUnlit.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Material/Material.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Material/Unlit/Unlit.hlsl"
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Material/Unlit/ShaderPass/UnlitDistortionPass.hlsl"
			#include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Material/Unlit/UnlitData.hlsl"
    ...
    SubShader
    {
        Pass
        {
            ...
            #include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Material/Unlit/UnlitRaytracingData.hlsl"
