...
#include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Material/SubsurfaceScattering/SubsurfaceScattering.hlsl"
#include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Material/NormalBuffer.hlsl"
#include "Assets/HDRP/com.unity.render-pipelines.core/ShaderLibrary/VolumeRendering.hlsl"
...
#include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Material/LTCAreaLight/LTCAreaLight.hlsl"
...
#include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Material/MaterialGBufferMacros.hlsl"
...
#include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Lighting/Reflection/VolumeProjection.hlsl"
#include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Lighting/ScreenSpaceLighting/ScreenSpaceTracing.hlsl"
...
#include "Assets/HDRP/com.unity.render-pipelines.core/ShaderLibrary/Refraction.hlsl"
...
NormalData ConvertSurfaceDataToNormalData(SurfaceData surfaceData)
{
    ...
    #endif
    {
		...
		normalData.perceptualRoughness = 1;// PerceptualSmoothnessToPerceptualRoughness(surfaceData.perceptualSmoothness);
    }
...
BSDFData ConvertSurfaceDataToBSDFData(uint2 positionSS, SurfaceData surfaceData)
{
	...
	bsdfData.perceptualRoughness = 1;// PerceptualSmoothnessToPerceptualRoughness(surfaceData.perceptualSmoothness);
...
#include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Lighting/LightEvaluation.hlsl"
#include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Material/MaterialEvaluation.hlsl"
#include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Lighting/SurfaceShading.hlsl"
...
#include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/Material/Lit/LitReference.hlsl"
...
float3 IntegrateSpecularGGXIBLRef1(LightLoopContext lightLoopContext,
                                    ...
                                    inout float hierarchyWeight)
{
	...
	envLighting = 0;// IntegrateSpecularGGXIBLRef1(lightLoopContext, V, preLightData, lightData, bsdfData);
