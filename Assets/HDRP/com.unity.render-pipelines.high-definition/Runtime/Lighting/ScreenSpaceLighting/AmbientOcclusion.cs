    ...
    public class AmbientOcclusionSystem
    {
        ...
        public AmbientOcclusionSystem(HDRenderPipelineAsset hdAsset)
        {
            ...
            m_AmbientOcclusionTex = RTHandles.Alloc(Vector2.one,
                ...
                colorFormat: UnityEngine.Experimental.Rendering.HDPipeline.HDRenderPipeline.OverrideRTGraphicsFormat(GraphicsFormat.R8_UNorm),
            ...
            if (supportMSAA)
            {
                m_MultiAmbientOcclusionTex = RTHandles.Alloc(Vector2.one,
                    filterMode: FilterMode.Bilinear,
                    colorFormat: UnityEngine.Experimental.Rendering.HDPipeline.HDRenderPipeline.OverrideRTGraphicsFormat(GraphicsFormat.R8G8_UNorm),
                    enableRandomWrite: true,
                    xrInstancing: true,
                    useDynamicScale: true,
            ...
            var fmtFP16 = supportMSAA ? UnityEngine.Experimental.Rendering.HDPipeline.HDRenderPipeline.OverrideRTGraphicsFormat(GraphicsFormat.R16G16_SFloat) : UnityEngine.Experimental.Rendering.HDPipeline.HDRenderPipeline.OverrideRTGraphicsFormat(GraphicsFormat.R16_SFloat);
            var fmtFP32 = supportMSAA ? UnityEngine.Experimental.Rendering.HDPipeline.HDRenderPipeline.OverrideRTGraphicsFormat(GraphicsFormat.R32G32_SFloat) : UnityEngine.Experimental.Rendering.HDPipeline.HDRenderPipeline.OverrideRTGraphicsFormat(GraphicsFormat.R32_SFloat);
            var fmtFX8  = supportMSAA ? UnityEngine.Experimental.Rendering.HDPipeline.HDRenderPipeline.OverrideRTGraphicsFormat(GraphicsFormat.R8G8_UNorm) : UnityEngine.Experimental.Rendering.HDPipeline.HDRenderPipeline.OverrideRTGraphicsFormat(GraphicsFormat.R8_UNorm);
