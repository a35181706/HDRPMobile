Shader "Hidden/HDRP/FinalPass"
{
    HLSLINCLUDE
        ...
        #include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/PostProcessing/Shaders/FXAA.hlsl"
        #include "Assets/HDRP/com.unity.render-pipelines.high-definition/Runtime/PostProcessing/Shaders/RTUpscale.hlsl"
